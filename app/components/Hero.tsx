...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="floating-shape w-64 h-64 top-20 left-10 opacity-30" style={{ animationDelay: "0s" }} />
      <div className="floating-shape w-48 h-48 top-40 right-20 opacity-20" style={{ animationDelay: "2s" }} />
      <div className="floating-shape w-32 h-32 bottom-40 left-1/4 opacity-25" style={{ animationDelay: "4s" }} />
        ...
        {isInView && (
          ...
          >
            ...
            <motion.p
              ...
              transition={{ duration: 0.3, delay: 0.1 }}
            >
              I'm <span className="text-primary font-semibold">Sahil Siddiqui</span>, a passionate web developer building
              websites that are{" "}
