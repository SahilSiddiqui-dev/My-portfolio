    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          , a web developer blending modern design principles with powerful technologies like 
          React, Next.js, and Tailwind CSS to build responsive, animated, and conversion-focused websites.
        </motion.p>
